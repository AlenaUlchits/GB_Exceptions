...
public class Checker {
    ...
    public void checkString(String value) throws StringLengthException {
        String[] str = null;
        if (value == null) {
            throw new StringLengthException("Data cannot be null");
        }
        str = value.split(" ");
        if (str.length != stringLength) {
            throw new StringLengthException("You have provided wrong number of parameters " + str.length + " it should be " + stringLength);
        }
    ...
    public User chekingUser() {
        ...
        try {
            ...
            System.out.println("Data that you entered are incorrect");
        }
        return  newUser;
    }
